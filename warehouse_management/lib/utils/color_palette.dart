...
mixin ColorPalette {
  ...
  // Royal Blue accent (updated app accent color)
  static const Color tealAccent = Color(0xFF2A5FD1);
  static const Color tealDark = Color(0xFF00897b);
  static const Color tealPrimary = Color(0xFF26A69A);  // HTML spec primary
  static const Color slate600 = Color(0xFF475569);

  // Extended gray scale (for text hierarchy and backgrounds)
  ...
  // Extended slate variants
  static const Color slate300 = Color(0xFFCBD5E1);
  static const Color slate900 = Color(0xFF0F172A);

  // Extended teal variants (brand family)
  ...
  // Rose colors indicate GIVE transactions (money leaving business)
