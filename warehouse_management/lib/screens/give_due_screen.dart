...
class GiveDueScreen extends StatefulWidget {
  ...
  @override
  State<GiveDueScreen> createState() => _GiveDueScreenState();
}

class _GiveDueScreenState extends State<GiveDueScreen> {
  ...
  void _onSubmit() {
    ...
    final result = DueTransactionResult(
      type: DueTxnType.give,  // This is GIVE screen - giving money to customer
                  ...
                  child: ConstrainedBox(
                    ...
                    child: Column(
                      ...
                      Container(
                        ...
                        child: Text(
                          'মোট দিবোঃ ${_formatBanglaAmount(_enteredAmount)} ৳',
