...
// Displays a single purchase item with receipt number, supplier, amount, and status
// Usage: PurchaseCard(purchase: purchaseObject)
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    // Left: Receipt number + Supplier info
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
